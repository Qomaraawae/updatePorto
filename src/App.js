...
function App() {
      ...
      <nav className={`fixed w-full z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <NavLink href="#about" icon={<User className="w-4 h-4" />} text="About" onClick={handleNavClick} />
              <NavLink href="#skills" icon={<Code className="w-4 h-4" />} text="Skills" onClick={handleNavClick} />
              <NavLink href="#projects" icon={<Briefcase className="w-4 h-4" />} text="Projects" onClick={handleNavClick} />
              <NavLink href="#contact" icon={<MessageSquare className="w-4 h-4" />} text="Contact" onClick={handleNavClick} />
            </div>
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-gray-900/95 backdrop-blur-sm shadow-lg">
            <MobileNavLink href="#about" icon={<User className="w-4 h-4" />} text="About" onClick={handleNavClick} />
            <MobileNavLink href="#skills" icon={<Code className="w-4 h-4" />} text="Skills" onClick={handleNavClick} />
            <MobileNavLink href="#projects" icon={<Briefcase className="w-4 h-4" />} text="Projects" onClick={handleNavClick} />
            <MobileNavLink href="#contact" icon={<MessageSquare className="w-4 h-4" />} text="Contact" onClick={handleNavClick} />
          </div>
        </div>
      </nav>
      ...
      <div className="min-h-screen relative flex flex-col justify-center items-center px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="flex gap-6 justify-center">
            ...
            <SocialLink href="https://t.me/elkaproject" icon={<MessageCircle />} />
            <SocialLink href="https://instagram.com/elkaproject" icon={<Instagram />} />
          </div>
        </div>
        <div 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              Hi, I'm Luthfi Komara, a front-end developer from Yogyakarta with a strong passion
              for crafting modern and interactive web experiences. I hold a degree in Information Systems
              from Universitas Ahmad Dahlan Yogyakarta.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
              As a beginner in front-end development, I'm continuously learning
              and expanding my skills in programming languages and frameworks.
              My journey started with a deep curiosity about how the web works,
              and now I'm focused on mastering new technologies to build seamless
      ...
      <section id="skills" className="py-20 px-4 bg-gray-800/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
            <SkillCard icon={<Code />} title="Frontend Development" items={['React.js', 'Next.js']} />
            <SkillCard icon={<Database />} title="Databases" items={['MySQL']} />
            <SkillCard icon={<Cloud />} title="Cloud Services" items={['Firebase', 'Supabase', 'Cloudinary']} />
          </div>
        </div>
      </section>
  ...
  <div className="max-w-8xl mx-auto">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      <a href="https://qomaraawae.github.io" target="_blank" rel="noopener noreferrer">
        <ProjectCard
      ...
      <a href="https://manageadmin.netlify.app" target="_blank" rel="noopener noreferrer">
        <ProjectCard
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
      {/* Email ContactCard */}
      <a href="mailto:luthfikomara04@gmail.com" target="_blank" rel="noopener noreferrer">
        <ContactCard icon={<Mail />} title="Email" value="luthfikomara04@gmail.com" />
      </a>

      {/* Instagram ContactCard */}
      <a href="https://www.instagram.com/qomaraawae" target="_blank" rel="noopener noreferrer">
        <ContactCard icon={<Instagram />} title="Instagram" value="@qomaraawae" />
      </a>

      {/* Telegram ContactCard */}
      <a href="https://t.me/qomaraawae" target="_blank" rel="noopener noreferrer">
      <ContactCard icon={<MessageCircle />} title="Telegram" value="@qomaraawae" />
      </a>
    </div>
    <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#about" onClick={handleNavClick} className="hover:text-white transition-colors">About</a></li>
                <li><a href="#skills" onClick={handleNavClick} className="hover:text-white transition-colors">Skills</a></li>
                <li><a href="#projects" onClick={handleNavClick} className="hover:text-white transition-colors">Projects</a></li>
                <li><a href="#contact" onClick={handleNavClick} className="hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <SocialLink href="https://github.com/qomaraawae" icon={<Github />} />
                <SocialLink href="https://www.linkedin.com/in/luthfi-komara-729026347/" icon={<Linkedin />} />
                <SocialLink href="mailto:luthfikomara04@gmail.com" icon={<Mail />} />
                <SocialLink href="https://t.me/qomaraawae" icon={<MessageCircle />} />
                <SocialLink href="https://instagram.com/qomaraawae" icon={<Instagram />} />
              </div>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>© {new Date().getFullYear()} ELKAProject. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
